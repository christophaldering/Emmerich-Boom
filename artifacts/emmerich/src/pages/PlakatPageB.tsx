    ...
    <div style={{ background: "#2a1f0e", minHeight: "100svh", display: "flex", flexDirection: "column", alignItems: "center", padding: "2rem 1rem", gap: "1.25rem" }}>
      ...
      >
        ...
        <div style={{
          ...
          {/* QR Code */}
          <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: "6%", position: "relative", zIndex: 2 }}>
            <div style={{
              background: "#fff",
      ...
      <style>{`
        @media print {
          ...
          body, html { margin: 0 !important; padding: 0 !important; background: #1a0e05 !important; }
