  ...
  return (
    <section style={{ background: "var(--bg-section)", padding: "2rem 1.5rem 2.5rem" }}>
      <style>{`
        ...
        .kai-result-wrap { margin-bottom:0.5rem; }
        ...
        .kai-text.collapsed { max-height:calc(1.9em * 4); }
        .kai-text.expanded-text { max-height:none; }
        .kai-read-more { background:none; border:none; cursor:pointer; padding:0.5rem 0 0; font-family:'Lora',serif; font-style:italic; font-size:0.95rem; color:var(--amber-75); transition:color 0.2s; display:block; }
        ...
        {inhalt && (
          <>
            <div className="kai-result-wrap">
              <p className={`kai-text ${expanded ? "expanded-text" : "collapsed"}`}>
                {inhalt}
              </p>
            </div>
