  ...
  return (
    ...
    >
      <style>{`
        ...
        .boomerclub-btn:hover {
          background: #1ebe5b;
          transform: translateY(-1px);
        }
        .boomerclub-btn:active { transform: none; }
        .boomerclub-qr-details {
          width: 100%;
          text-align: center;
        }
        .boomerclub-qr-details summary {
          list-style: none;
          cursor: pointer;
        }
        ...
        .boomerclub-qr-hint {
          ...
          text-decoration-color: rgba(245,232,200,0.25);
        }
      `}</style>
      ...
      <div className="boomerclub-wrap">
        ...
        <a
          href="https://chat.whatsapp.com/Ie7Jo01K44H8BREFq4XuIV?mode=gi_t"
          target="_blank"
          rel="noopener noreferrer"
          className="boomerclub-btn"
        >
