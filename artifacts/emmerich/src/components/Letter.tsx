    ...
    >
      ...
      <div className="reveal" style={{ animationDelay: "0.55s" }}>
        ...
        <div className="letter-body">
          ...
          <p>Und jetzt das Wichtigste: Die Anmeldung ist nun freigeschaltet — 10&nbsp;€ pro Person, Anmeldung bis Ende Juni 2026. Wer schon weiß, dass er dabei ist: direkt verbindlich anmelden und Platz sichern. Wer zusätzlich ein Statement hinterlassen und einen Musikwunsch platzieren möchte, gerne — aber: ein Ticket gibt's nur mit der verbindlichen Anmeldung.</p>
        </div>
      </div>
    </section>
  );
