...
const sections = [
  {
    title: "Impressum",
    content: (
      <div style={{ padding: "1.2rem 0 0.5rem", fontSize: "0.85rem", lineHeight: 1.9, color: "rgba(245,232,200,0.55)" }}>
        ...
        <br />
        <p>Kontakt<br />
        E-Mail: christoph.aldering@googlemail.com</p>
        <br />
        <p>Hinweis<br />
  ...
  },
  {
    ...
    content: (
      <div style={{ padding: "1.2rem 0 0.5rem", fontSize: "0.85rem", lineHeight: 1.9, color: "rgba(245,232,200,0.55)" }}>
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Verantwortlicher</strong><br />
        Christoph Aldering, Jakob-Troost-Straße 8, 46446 Emmerich am Rhein<br />
        E-Mail: christoph.aldering@googlemail.com</p>
        <br />
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Welche Daten wir erheben</strong><br />
        ...
        <br />
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Zweck der Datenerhebung</strong><br />
        ...
        <br />
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Speicherung</strong><br />
        ...
        <br />
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Rechtsgrundlage</strong><br />
        ...
        <br />
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Ihre Rechte</strong><br />
        ...
        <br />
        <p><strong style={{ color: "rgba(245,232,200,0.7)", fontWeight: 600 }}>Hosting</strong><br />
  ...
  },
  {
    ...
    content: (
      <div style={{ padding: "1.2rem 0 0.5rem", fontSize: "0.85rem", lineHeight: 1.9, color: "rgba(245,232,200,0.55)" }}>
        ...
        christoph.aldering@googlemail.com</p>
        <br />
      ...
      {sections.map((s, i) => (
        <div key={i}>
          ...
          <div
            ...
            style={{ maxHeight: open === i ? "1200px" : "0" }}
          >
            {s.content}
          </div>
        </div>
